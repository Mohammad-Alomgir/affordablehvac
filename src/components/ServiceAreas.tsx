...
export default function ServiceAreas() {
  ...
  return (
    <section id="service-areas" className="py-24 bg-[#061830] border-b border-brand-blue-950 text-white relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none z-0">
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[950px] h-[950px] border border-white/[0.03] border-dashed rounded-full" />
      </div>
      ...
      <div className="max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <h2 className="font-display font-bold text-4xl sm:text-5xl text-white tracking-normal leading-[1.12]">
            Proudly Serving <span className="text-[#C41230]">New Brunswick</span>
          </h2>
          <p className="mt-5 text-[15px] sm:text-[16px] text-slate-300 font-sans leading-relaxed max-w-2xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5 lg:gap-6">
          {serviceAreasData.map((area) => (
            <button
              ...
              className="bg-[#0a1e36]/40 hover:bg-[#0f2d52]/65 hover:scale-[1.02] border border-white/10 hover:border-white/20 p-5 rounded-2xl flex items-center justify-between text-left group transition-all duration-300 cursor-pointer w-full select-all"
              ...
              <div className="flex items-center">
                ...
                <Navigation 
                  className={`w-5 h-5 shrink-0 transition-transform duration-300 group-hover:scale-110 ${
                    area.isPrimary ? "text-[#C41230]" : "text-slate-400 group-hover:text-white"
                  }`} 
                />
                <span className="font-display font-bold text-[18px] text-white tracking-wide ml-4">
                  {area.name}
                </span>
              </div>
        ...
        <div className="mt-14 text-center">
          <button
            ...
            className="inline-flex items-center justify-center gap-2.5 border border-white/20 hover:border-white/45 bg-transparent hover:bg-white/5 text-white px-10 py-4 rounded-xl text-xs font-display font-bold uppercase tracking-[0.2em] transition-all duration-300 cursor-pointer shadow-lg shadow-black/10"
          >
        ...
        {activeArea && currentDetails && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            <motion.div
              ...
              className="relative w-full max-w-md bg-[#0a1e36] border border-white/15 rounded-2xl p-6 sm:p-8 shadow-2xl text-left z-10 text-white overflow-hidden"
            >
              {/* Top Accent Bar */}
              ...
              <div className="flex items-center gap-2.5 mb-6">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-400 mt-0.5">Coverage Station Details</p>
                </div>
              </div>

              {/* Sub-status tag */}
              <div className="mb-6 flex items-center justify-between bg-white/5 py-1.5 px-3 rounded-lg border border-white/5">
                <span className="text-[10px] text-slate-400 uppercase tracking-wider font-bold">Network Status</span>
              ...
              <div className="space-y-3.5 mb-8">
                <div className="flex justify-between items-center bg-white/5 px-4.5 py-3 rounded-xl border border-white/5">
                  <div className="flex items-center gap-2">
                    <Clock className="w-4 h-4 text-[#C41230]" />
                    <span className="text-xs text-slate-300 font-sans font-medium">Response Time</span>
                  </div>
                  <span className="text-xs font-bold text-white font-mono">{currentDetails.response}</span>
                </div>
                <div className="flex justify-between items-center bg-white/5 px-4.5 py-3 rounded-xl border border-white/5">
                  <div className="flex items-center gap-2">
                    <ShieldCheck className="w-4 h-4 text-[#C41230]" />
                    <span className="text-xs text-slate-300 font-sans font-medium">Coverage Staff</span>
                  </div>
                  <span className="text-xs font-bold text-white font-mono">{currentDetails.technicians}</span>
                </div>
              </div>
              ...
              <div className="border-t border-white/10 pt-5 flex items-center justify-between">
                <div>
                  <p className="text-[10px] text-slate-400 uppercase tracking-widest font-sans font-bold">Need Emergency Help?</p>
                  <a
                    href="tel:5062910594"
                    className="text-white hover:text-[#C41230] font-display font-bold text-[16px] tracking-wide block mt-1 transition-colors select-all"
                  >
                    (506) 291-0594
                  </a>
                </div>
