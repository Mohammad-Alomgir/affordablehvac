...
export default function Foundation() {
  ...
  return (
    <section id="about-us" className="py-24 bg-[#061830] text-white relative overflow-hidden">
        ...
        <div className="grid lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-5 relative">
            <div className="relative rounded-2xl overflow-hidden shadow-2xl border border-white/5">
              ...
              />
              <div className="absolute inset-0 bg-gradient-to-t from-[#061830]/60 via-transparent to-transparent pointer-events-none" />
            </div>
          ...
          <div className="lg:col-span-7 flex flex-col justify-center items-start text-left">
            ...
            <h2 className="font-display font-bold text-4xl sm:text-5xl text-white mt-1 leading-[1.12] tracking-normal mb-6">
              Serving Our Community with<br />
              <span className="text-[#C41230]">Faith, Integrity,</span> & Excellence
            </h2>

            <div className="space-y-5 text-[15px] sm:text-[16px] text-slate-300 leading-relaxed font-sans max-w-2xl">
              <p>
            ...
            <div className="mt-8 space-y-4 w-full max-w-2xl">
              {bulletPoints.map((point, idx) => (
                <div key={idx} className="flex items-start gap-3">
                  ...
                  <span className="text-[14px] sm:text-[15px] text-slate-200 font-sans leading-snug">{point}</span>
                </div>
              ))}
            </div>
            ...
            <button
              ...
              className="mt-10 inline-flex items-center gap-2 border border-white/20 hover:border-white/40 rounded-lg px-7 py-3.5 text-xs font-display font-bold text-white uppercase tracking-[0.18em] transition-all duration-300 bg-transparent hover:bg-white/5 cursor-pointer"
            >
        ...
        {showStoryDetail && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            <motion.div
              ...
              className="absolute inset-0 bg-brand-blue-950/85 backdrop-blur-xs"
            />
            ...
            >
              ...
              <div className="space-y-4 text-xs sm:text-sm text-gray-600 font-sans leading-relaxed">
                ...
                <div className="bg-gray-50 border-l-4 border-brand-red-500 p-4 rounded-r-lg my-4 italic text-brand-blue-900 font-sans text-xs">
              ...
              <div className="mt-8 border-t border-gray-100 pt-6 flex flex-wrap justify-end gap-3">
                <button
                  onClick={() => setShowStoryDetail(false)}
                  className="bg-brand-blue-900 hover:bg-brand-blue-800 text-white font-display text-xs font-bold uppercase tracking-wider px-6 py-3 rounded-lg cursor-pointer transition-colors"
                >
                  Close Story
                </button>
              </div>
